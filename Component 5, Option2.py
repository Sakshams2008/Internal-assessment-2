...
def show_help():
    help_message = (
        ...
        "Features:\n"
        "- Enter team info by click on the Enter Team Info button\n"
        "- For running a single match, click Start simulation after filling the team info\n"
        "- For tournament mode, click the Tournament Mode button and then select Bo3 or Bo5\n"
...
tk.Button(root, text="Help", command=show_help, width=18, bg="gray", fg="white").pack(pady=5)
