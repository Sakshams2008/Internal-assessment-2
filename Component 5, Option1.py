...
def show_about():
    about_message = (
        ...
        "This app simulates cricket matches and tournaments with stats tracking and viewing previous matches.\n\n"
        "Enjoy the app!"
    )
...
tk.Button(root, text="About", command=show_about, width=18, bg="gray", fg="white").pack(pady=5)
